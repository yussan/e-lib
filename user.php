...
?>
		...
		<div id="container">
					<section class="section" id="section1" data-section="1" >
							...
							<div  class="title"><h1 style="margin-left:20px">Upload By : <?php echo $user; ?></h1></div>
							<div>
								<div class="book_top" style="width:100%">
									<div class="fluid-row">
									<?php
										//php to read book item on database	
										$sql = mysql_query("SELECT * FROM book WHERE user = '".$user."'");					
